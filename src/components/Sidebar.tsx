...
import { LayoutDashboard, Users, Scissors, ShoppingBag, Palette, CalendarClock, Wallet, MessageSquare, LogOut, UserCircle, X } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto pr-2">
          <p className="mb-4 pl-3 text-xs font-semibold uppercase tracking-[0.3em] text-cyan-400">
            Modules
          </p>
